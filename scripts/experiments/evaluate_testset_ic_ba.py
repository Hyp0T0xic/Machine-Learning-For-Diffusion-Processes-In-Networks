#!/usr/bin/env python
"""ic-ba test-set evaluation: top-1, top-3, mrr, mean hops + rf hop distribution + 2x2 confusion matrix, averaged across 5 seeds"""
...
def main() -> None:
    print(f"ic-ba test-set evaluation, size=25, {len(SEEDS)} seeds")
    ...
    print(f"\naveraged results over {len(SEEDS)} seeds (ic on ba)")
    ...
    bars = ax.bar(labels, percentages, color=METHOD_COLORS["RF (IC-BA)"],
