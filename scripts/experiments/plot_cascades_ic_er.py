"""
scripts/experiments/plot_cascades_ic_er.py
Show example cascades for IC on ER across different R0 values.
"""
...
def main() -> None:
    ...
    out_path = Path("results/figures/cascades/examples_ic_er.png")
