"""
scripts/experiments/plot_r0_comparison_er.py
Show example cascades on an ER network at various R0 values.
"""
...
def main() -> None:
    ...
    fig.suptitle(
        f"ER Network Cascade Examples (size={CASCADE_SIZE})\n"
        f"R0=0.5 (weak) | R0=1.0 (critical) | R0=3.0 (strong) | R0=5.0 (explosive)",
        color="white", fontweight="bold", fontsize=14, y=1.02
    )
    plt.tight_layout()

    out_path = Path("results/figures/cascades/er_examples_all_r0.png")
