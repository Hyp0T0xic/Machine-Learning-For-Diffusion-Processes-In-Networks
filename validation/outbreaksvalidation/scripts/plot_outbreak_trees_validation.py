#!/usr/bin/env python
"""
Plot OutbreakTrees biological validation results from saved JSON.
Reads: data/validate_outbreak_trees.json
Writes: figures/outbreak_trees_validation.png

Usage: python validation/outbreaksvalidation/scripts/plot_outbreak_trees_validation.py
"""
...
def main() -> None:
    ...
    with open(DATA_DIR / "validate_outbreak_trees.json") as f:
        data = json.load(f)
    ...
    plt.tight_layout()
    out_file = OUT_DIR / "outbreak_trees_validation.png"
